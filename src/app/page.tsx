      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <footer className="border-t border-border/30 py-4">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center text-xs text-muted-foreground">
            © {new Date().getFullYear()} FrameMaxx. All rights reserved.
          </div>
        </footer>
      </div>
    );
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Tell us who you are so we can reach out.
                        </p>
                      </div>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            updateField("projectTimeline", value)
                          }
                        >
                          <SelectTrigger className="bg-input/50 border-border/30 focus:border-primary/50 focus:ring-primary/20">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          id="featuresRequired"
                          placeholder="e.g., User authentication, payment integration, admin dashboard, SEO optimization..."
                          value={formData.featuresRequired}
                          onChange={(e) =>
                            updateField("featuresRequired", e.target.value)
                          }
                          rows={4}
                  ...
                  {currentStep === 2 && (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Almost there! Add any references or notes.
                        </p>
                      </div>
                                ...
                                <DialogContent className="bg-card border-border/50 max-h-[80vh] overflow-y-auto">
                                  ...
                                  <div className="text-sm text-muted-foreground space-y-4 leading-relaxed">
                                    <p>
                                      ...
                                      <br />
                                      By submitting a project request through the
                                      FrameMaxx client intake portal, you agree to be
                                    ...
                                    <p>
                                      ...
                                      <br />
                                      All project submissions are subject to review.
                                      FrameMaxx reserves the right to decline any
                                      project that does not align with our capabilities
                                      or values.
                                    </p>
                                    <p>
                                      <strong className="text-foreground">
                                      ...
                                      <br />
                                      FrameMaxx treats all client information as
                                      confidential. We will not share your project
                                      details with third parties without explicit
                                      consent.
                                    </p>
                                    <p>
                                      <strong className="text-foreground">
                                      ...
                                      <br />
                                      All quotes provided are estimates based on the
                                      information submitted. Final pricing may vary
                                    ...
                                    <p>
                                      ...
                                      <br />
                                      Upon full payment, all custom code and design
                                      assets created for your project will be
                                      transferred to you, unless otherwise agreed.
                                    </p>
                                  </div>
                                </DialogContent>
                              </Dialog>{" "}
                                ...
                                <DialogContent className="bg-card border-border/50 max-h-[80vh] overflow-y-auto">
                                  ...
                                  <div className="text-sm text-muted-foreground space-y-4 leading-relaxed">
                                    <p>
                                      ...
                                      <br />
                                      We collect the information you provide through
                                      our intake form: name, email, business name,
                                      project details, and any additional notes.
                                    </p>
                                    <p>
                                      <strong className="text-foreground">
                                      ...
                                      <br />
                                      Your information is used solely to evaluate
                                      your project request, communicate with you
                                      about potential engagement, and provide our
                                      services.
                                    </p>
                                    <p>
                                      <strong className="text-foreground">
                                    ...
                                    <p>
                                      ...
                                      <br />
                                      We retain your submission data for up to 12
                                      months. You may request deletion at any time by
                                      contacting us.
                                    </p>
                                    <p>
                                      <strong className="text-foreground">
                                      ...
                                      delete your personal data. Contact us at any
