...
const row: React.CSSProperties = { display: "flex", marginBottom: 8, fontSize: 14.5, lineHeight: 1.55, textRendering: "geometricPrecision" };
const lbl: React.CSSProperties = { width: 170, fontWeight: 600, color: grayText, flexShrink: 0, fontSize: 14.5, textRendering: "geometricPrecision" };
const para: React.CSSProperties = { fontSize: 14.5, color: grayText, lineHeight: 1.65, marginBottom: 5, textRendering: "geometricPrecision" };
...
function ndaRender(data: Record<string, string | boolean>) {
  ...
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", color: darkText, fontSize: 14.5, textRendering: "geometricPrecision", WebkitFontSmoothing: "antialiased" }}>
        ...
        <div style={sec}>
          <div style={{ fontSize: 10, width: "100%" }}>
            ...
            {visibleItems.map((it, i) => (
              <div key={i} style={{ display: "flex", borderBottom: "1px solid #EEE", padding: "12px 0 10px 0", color: grayText, fontSize: 13 }}>
...
function privacyTermsRender(data: Record<string, string | boolean>) {
  ...
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", color: darkText, fontSize: 13, textRendering: "geometricPrecision", WebkitFontSmoothing: "antialiased" }}>
