...
const row: React.CSSProperties = { display: "flex", marginBottom: 8, fontSize: 13.5, lineHeight: 1.5, textRendering: "geometricPrecision" };
const lbl: React.CSSProperties = { width: 170, fontWeight: 600, color: grayText, flexShrink: 0, fontSize: 13.5, textRendering: "geometricPrecision" };
const para: React.CSSProperties = { fontSize: 13.5, color: grayText, lineHeight: 1.6, marginBottom: 5, textRendering: "geometricPrecision" };
        ...
        <div style={sec}>
          <div style={{ fontSize: 10, width: "100%" }}>
            ...
            {visibleItems.map((it, i) => (
              <div key={i} style={{ display: "flex", borderBottom: "1px solid #EEE", padding: "12px 0 10px 0", color: grayText, fontSize: 12 }}>
