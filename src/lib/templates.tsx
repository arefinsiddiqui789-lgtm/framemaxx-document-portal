...
const secH: React.CSSProperties = {
  ...
  color: gold, marginBottom: 5, paddingBottom: 4, borderBottom: `1px solid ${borderColor}`,
};
const row: React.CSSProperties = { display: "flex", marginBottom: 8, fontSize: 13.75, lineHeight: 1.5, textRendering: "geometricPrecision" };
const lbl: React.CSSProperties = { width: 170, fontWeight: 600, color: grayText, flexShrink: 0, fontSize: 13.75, textRendering: "geometricPrecision" };
const para: React.CSSProperties = { fontSize: 13.75, color: grayText, lineHeight: 1.6, marginBottom: 5, textRendering: "geometricPrecision" };
...
function FR({ label, value }: { label: string; value: string }) {
  return (
    <div style={row}>
      ...
      <span style={{ color: value ? darkText : grayText, flexGrow: 1, borderBottom: "1px solid #DDD", paddingBottom: 10, display: "inline-block" }}>{value || "—"}</span>
    </div>
  );
}
...
function CFR({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div style={row}>
      <span style={lbl}>{label}</span>
      <span style={{ color: darkText, flexGrow: 1, borderBottom: "1px solid #DDD", paddingBottom: 10, display: "inline-block" }}>{value}</span>
    </div>
  );
}
...
function ndaRender(data: Record<string, string | boolean>) {
  ...
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", color: darkText, fontSize: 13.75, textRendering: "geometricPrecision", WebkitFontSmoothing: "antialiased" }}>
        ...
        <div style={sec}>
          <div style={{ fontSize: 10, width: "100%" }}>
            ...
            {visibleItems.map((it, i) => (
              <div key={i} style={{ display: "flex", borderBottom: "1px solid #EEE", padding: "12px 0 10px 0", color: grayText, fontSize: 12.5 }}>
...
function privacyTermsRender(data: Record<string, string | boolean>) {
  ...
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", color: darkText, fontSize: 12.5, textRendering: "geometricPrecision", WebkitFontSmoothing: "antialiased" }}>
